...
import net.kernal.spiderman.worker.extract.util.DefaultLinkFinder;
import net.kernal.spiderman.worker.extract.util.FrameLinkFinder;
import net.kernal.spiderman.worker.extract.util.IframeLinkFinder;
...
public final class URLKit {
	...
	private static Url normalize(final Url baseUrl, final String relativeUrl) {
